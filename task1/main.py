...
if __name__ == '__main__':
    ...
    SELECT_TYPE_EVEN = 'even'
    SELECT_TYPE_ODD = 'odd'
    SELECT_TYPE_SIMPLE = 'simple'
    ...
    output = selector(input_numbers, select=SELECT_TYPE_EVEN)
    print(f'Четные числа: {len(output)} элементов')
    print(output)
    print()

    output = selector(input_numbers, select=SELECT_TYPE_ODD)
    print(f'Нечетные числа: {len(output)} элементов')
    print(output)
    print()

    output = selector(input_numbers, select=SELECT_TYPE_SIMPLE)
